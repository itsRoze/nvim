return {
  ...
  config = function()
    ...
    keyset("x", ",a", "<Plug>(coc-codeaction-selected)", opts)
    keyset("n", ",a", "<Plug>(coc-codeaction-selected)", opts)

    -- Remap keys for apply code actions at the cursor position.
    keyset("n", ",ac", "<Plug>(coc-codeaction-cursor)", opts)
    -- Remap keys for apply code actions affect whole buffer.
    keyset("n", ",as", "<Plug>(coc-codeaction-source)", opts)
    ...
    keyset("n", "ca", ":<C-u>CocList diagnostics<cr>", opts)
    -- Manage extensions
    keyset("n", "ce", ":<C-u>CocList extensions<cr>", opts)
    -- Show commands
    keyset("n", "cc", ":<C-u>CocList commands<cr>", opts)
    -- Find symbol of current document
    keyset("n", "co", ":<C-u>CocList outline<cr>", opts)
    -- Search workspace symbols
    keyset("n", "cs", ":<C-u>CocList -I symbols<cr>", opts)
    -- Do default action for next item
    keyset("n", "cj", ":<C-u>CocNext<cr>", opts)
    -- Do default action for previous item
    keyset("n", "ck", ":<C-u>CocPrev<cr>", opts)
    -- Resume latest coc list
    keyset("n", "cp", ":<C-u>CocListResume<cr>", opts)
  end,
}
